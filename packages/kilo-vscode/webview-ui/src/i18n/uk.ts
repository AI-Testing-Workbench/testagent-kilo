export const dict = {
  ...
  "settings.context.autoCompaction.description": "Коли контекст наближається до ліміту, надсилає старішу історію (без інструментів, без системних підказок, медіа замінено заповнювачами, виведення інструментів скорочено до 2000 символів) спеціальному агенту стиснення для структурованого підсумовування, зберігає останні 2 раунди розмови та автоматично продовжує сесію",
