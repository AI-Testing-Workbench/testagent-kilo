export const dict = {
  ...
  "settings.browser.vscodeTools.title": "Використовувати вбудований браузер VS Code",
  "settings.browser.vscodeTools.description":
    "Дозволити агенту працювати у вбудованому браузері VS Code. Без додаткового встановлення; сторінки відкриваються у вкладці редактора. Потрібен VS Code 1.110 або новіший і параметр Workbench > Browser: Enable Chat Tools.",
  "settings.browser.enable.title": "Увімкнути автоматизацію браузера",
  "settings.browser.enable.description":
    "Зареєструвати MCP-сервер Playwright з CLI-бекендом. Вимкне вбудований браузер вище.",
  "settings.browser.playwrightOptions.title": "Параметри Playwright",
  ...
  "settings.context.autoCompaction.description":
    "Коли контекст наближається до ліміту, надсилає старішу історію (без інструментів, без системних підказок, медіа замінено заповнювачами, виведення інструментів скорочено до 2000 символів) спеціальному агенту стиснення для структурованого підсумовування, зберігає останні 2 раунди розмови та автоматично продовжує сесію",
