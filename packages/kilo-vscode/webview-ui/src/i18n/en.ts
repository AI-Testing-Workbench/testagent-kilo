export const dict = {
  ...
  "model.thinking.toggle": "Enable thinking",
  ...
  "revert.confirm.warning": "Resetting this checkpoint will also revert file changes. Please proceed with caution!",
  "revert.confirm.confirm": "Confirm",
  "revert.confirm.cancel": "Cancel",
  ...
  "provider.custom.models.variants.splitReasoning.label": "Split reasoning (e.g. MiniMax)",
  ...
  "provider.custom.models.modalities.image": "Supports images",
  ...
  "prompt.placeholder.busy": "Waiting for the current task to complete",
  ...
  "settings.agentBehaviour.addMcp.url.required": "Server URL is required for remote MCP servers",
  "settings.agentBehaviour.editMcp.timeout": "Timeout (s)",
  ...
  "settings.agentBehaviour.addMcpDialog.nameRequired": "Server name is required",
  "settings.agentBehaviour.addMcpDialog.nameTaken": "A server with this name already exists",
