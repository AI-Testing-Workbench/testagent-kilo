...
export const dict = {
  ...
  "settings.notifications.questions.title": "需要選擇",
  "settings.notifications.questions.description": "Agent 提問時顯示通知",
  "settings.notifications.errors.title": "錯誤",
  "settings.notifications.errors.description": "發生錯誤時顯示通知",
  "settings.notifications.subagent.title": "子任務通知",
  "settings.notifications.subagent.description": "子任務的權限、問答、錯誤也顯示通知",
  ...
  "settings.experimental.mcpTimeout.title": "MCP 逾時（秒）",
  "settings.experimental.mcpTimeout.description": "MCP 伺服器請求的逾時時間（秒）",
  ...
  "settings.agentBehaviour.addMcp.url.required": "遠端 MCP 伺服器必須填寫 URL",
