...
export const dict = {
  ...
  "revert.confirm.warning": "若重置此检查点，则文件变更也同样撤销，请谨慎操作！",
  "revert.confirm.confirm": "确定",
  "revert.confirm.cancel": "取消",
  ...
  "provider.custom.models.variants.splitReasoning.label": "分离推理（如 MiniMax）",
  ...
  "provider.custom.models.variants.outputEffort.label": "输出强度（如 Anthropic）",
  ...
  "prompt.placeholder.busy": "等待当前任务完成后方可继续输入",
  ...
  "settings.notifications.questions.title": "需要选择",
  "settings.notifications.questions.description": "智能体提问时显示通知",
  ...
  "settings.notifications.zhAnswer.title": "企业招乎回答", // testagent_change
  "settings.notifications.zhAnswer.description": "任务权限/提问推送到企业招乎，手机端即可回复（本地模式需同时配置 testagent.zhRelayUrl）", // testagent_change
  ...
  "settings.agentBehaviour.addMcpButton": "添加 MCP 服务器",
  "settings.agentBehaviour.addMcpDialog.title": "添加 MCP 服务器",
  "settings.agentBehaviour.addMcpDialog.name": "服务器名称",
  "settings.agentBehaviour.addMcpDialog.name.placeholder": "e.g. my-filesystem-server",
  "settings.agentBehaviour.addMcpDialog.nameRequired": "服务器名称不能为空",
  "settings.agentBehaviour.addMcpDialog.nameTaken": "该名称已被使用",
