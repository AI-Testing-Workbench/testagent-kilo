...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "TestAgent Autocomplete",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "TestAgent Autocomplete (disabled)",
  ...
  "kilocode:autocomplete.toggleMessage": "TestAgent Autocomplete {{status}}",
  "kilocode:autocomplete.progress.title": "TestAgent",
  ...
  "kilocode:autocomplete.input.title": "TestAgent: Quick Task",
  "kilocode:autocomplete.input.placeholder": "e.g., 'refactor this function to be more efficient'",
  "kilocode:autocomplete.commands.generateSuggestions": "TestAgent: Generate Suggested Edits",
  ...
  "kilocode:autocomplete.commands.category": "TestAgent",
  "kilocode:autocomplete.codeAction.title": "TestAgent: Suggested Edits",
  "kilocode:autocomplete.chatParticipant.fullName": "TestAgent Agent",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "The TestAgent Autocomplete is being blocked by a conflict with GitHub Copilot. To fix this, you must disable Copilot's inline suggestions.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "TestAgent Autocomplete has been paused because your account has no remaining credits. Add credits to resume autocomplete.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Add Credits",
  "kilocode:autocomplete.authError.message":
    "TestAgent Autocomplete has been paused due to an authentication error. Please sign in again.",
}
