...
const SUPPORTED_PROVIDER_DISPLAY_NAME = "TestAgent Gateway"
const SETTINGS_COMMAND = `command:testagent.new.settingsButtonClicked?${encodeURIComponent(JSON.stringify(["autocomplete"]))}`
