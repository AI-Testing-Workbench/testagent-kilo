...
const TESTAGENTIGNORE = ".testagentignore" // testagent_change
const GITIGNORE = ".gitignore"

/**
 * Patterns for sensitive environment files, applied only when no .testagentignore exists.
 */
...
export class FileIgnoreController {
  ...
  async initialize(): Promise<void> {
    ...
    // Try .testagentignore first — if it exists, use only that. // testagent_change
